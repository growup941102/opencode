import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@self-opencode/llm"
...
// Move this extraction into @self-opencode/llm when Copilot is handled by the native runtime.
