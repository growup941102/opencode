import type { JsonSchema, LLMRequest, ProviderMetadata } from "@self-opencode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@self-opencode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @self-opencode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
