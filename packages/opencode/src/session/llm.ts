...
import { llmClient } from "@self-opencode/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@self-opencode/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@self-opencode/llm/route"
import type { LLMClientService } from "@self-opencode/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @self-opencode/llm. It
