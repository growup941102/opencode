import type { Session as SDKSession, Message, Part } from "@self-opencode/sdk/v2"
...
import { SessionTable, MessageTable, PartTable } from "@self-opencode/core/session/sql"
