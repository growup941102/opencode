...
import type { ConsoleState } from "@self-opencode/core/v1/config/console-state"
import { FSUtil } from "@self-opencode/core/fs-util"
import { InstanceState } from "@/effect/instance-state"
import { Context, Duration, Effect, Exit, Fiber, Layer, Option, Schema } from "effect"
import { FetchHttpClient, HttpClient, HttpClientRequest } from "effect/unstable/http"
import { EffectFlock } from "@self-opencode/core/util/effect-flock"
import { containsPath, type InstanceContext } from "../project/instance-context"
import { ConfigV1 } from "@self-opencode/core/v1/config/config"
import { RemoteAuthError } from "@self-opencode/core/v1/config/error"
import { ConfigPermissionV1 } from "@self-opencode/core/v1/config/permission"
