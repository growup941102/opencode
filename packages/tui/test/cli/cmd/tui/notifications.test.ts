...
import type { Event, PermissionRequest, QuestionRequest, Session } from "@self-opencode/sdk/v2"
import type { TuiAttentionNotifyInput } from "@self-opencode/plugin/tui"
