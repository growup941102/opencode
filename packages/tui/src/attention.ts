...
} from "@self-opencode/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@self-opencode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@self-opencode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@self-opencode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@self-opencode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@self-opencode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@self-opencode/ui/audio/yup-01.mp3" with { type: "file" }
