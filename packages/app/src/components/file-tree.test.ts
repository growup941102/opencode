...
beforeAll(async () => {
  ...
  mock.module("@self-opencode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@self-opencode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@self-opencode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@self-opencode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
