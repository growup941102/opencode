import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@self-opencode/sdk/v2"
import { SessionTurn } from "@self-opencode/ui/session-turn"
import { SessionReview } from "@self-opencode/ui/session-review"
import { DataProvider } from "@self-opencode/ui/context"
import { FileComponentProvider } from "@self-opencode/ui/context/file"
import { WorkerPoolProvider } from "@self-opencode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@self-opencode/ui/logo"
import { IconButton } from "@self-opencode/ui/icon-button"
import { ProviderIcon } from "@self-opencode/ui/provider-icon"
import { iife } from "@self-opencode/core/util/iife"
import { Binary } from "@self-opencode/core/util/binary"
import { NamedError } from "@self-opencode/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@self-opencode/ui/tabs"
import { MessageNav } from "@self-opencode/ui/message-nav"
import { FileSSR } from "@self-opencode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@self-opencode/ui/pierre/worker").then((m) => ({
