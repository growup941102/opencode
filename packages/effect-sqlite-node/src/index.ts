...
export const TypeId: TypeId = "~@self-opencode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@self-opencode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@self-opencode/effect-sqlite-node/NodeSqliteClient")
