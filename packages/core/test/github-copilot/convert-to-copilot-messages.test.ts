import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@self-opencode/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
