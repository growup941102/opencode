...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@self-opencode/llm"
import * as OpenAIChat from "@self-opencode/llm/protocols/openai-chat"
import { Database } from "@self-opencode/core/database/database"
import { EventV2 } from "@self-opencode/core/event"
import { PermissionV2 } from "@self-opencode/core/permission"
import { EventTable } from "@self-opencode/core/event/sql"
import { Project } from "@self-opencode/core/project"
import { ProjectTable } from "@self-opencode/core/project/sql"
import { QuestionV2 } from "@self-opencode/core/question"
import { AbsolutePath } from "@self-opencode/core/schema"
import { SessionV2 } from "@self-opencode/core/session"
import { ContextSnapshotDecodeError } from "@self-opencode/core/session/error"
import { SessionEvent } from "@self-opencode/core/session/event"
import { SessionInput } from "@self-opencode/core/session/input"
import { SessionMessage } from "@self-opencode/core/session/message"
import { Prompt } from "@self-opencode/core/session/prompt"
import { SessionProjector } from "@self-opencode/core/session/projector"
import { SessionExecution } from "@self-opencode/core/session/execution"
import { SessionContextEpoch } from "@self-opencode/core/session/context-epoch"
import { SessionRunCoordinator } from "@self-opencode/core/session/run-coordinator"
import { SessionRunner } from "@self-opencode/core/session/runner"
import * as SessionRunnerLLM from "@self-opencode/core/session/runner/llm"
import { SessionRunnerModel } from "@self-opencode/core/session/runner/model"
import { ToolRegistry } from "@self-opencode/core/tool/registry"
import { ToolOutputStore } from "@self-opencode/core/tool-output-store"
import { ApplicationTools } from "@self-opencode/core/tool/application-tools"
import { AgentV2 } from "@self-opencode/core/agent"
import { Config } from "@self-opencode/core/config"
import { ConfigCompaction } from "@self-opencode/core/config/compaction"
import { Tool } from "@self-opencode/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@self-opencode/core/session/sql"
import { SessionStore } from "@self-opencode/core/session/store"
import { SystemContext } from "@self-opencode/core/system-context"
import { SystemContextRegistry } from "@self-opencode/core/system-context/registry"
import { SkillGuidance } from "@self-opencode/core/skill/guidance"
import { ReferenceGuidance } from "@self-opencode/core/reference/guidance"
import { ModelV2 } from "@self-opencode/core/model"
