...
- remove the public in-memory `@self-opencode/llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@self-opencode/llm` orchestration exports
